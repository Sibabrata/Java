...
public class LoginTest {
	...
	private static final String Choudharysibabrata = null;
...
//		tatocGameBaseUrl = getYamlValue("tatocGameBaseUrl");s
	...
	/*//@Test(priority=2)
      ...
      // test.loginPage.enterLoginCredentials(choudharysibabrata, Cengage_2);
		//test.loginPage.clickOnLoginPanel();
		//test.loginPage.clickOnLogin();
		//test.loginPage.WindowHandle();
		//test.loginPage.BrowserWindowHandle();
		test.loginPage.Practice();
		//test.loginPage.Alert();
*/		
