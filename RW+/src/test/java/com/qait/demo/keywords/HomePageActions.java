...
public class HomePageActions extends GetPage {
	...
	public void loginAdminUser(){
		element("inp_username").sendKeys(YamlReader.getYamlValue("adminUsername"));
		String username=YamlReader.getYamlValue("adminUsername");
		element("inp_password").sendKeys(YamlReader.getYamlValue("adminPassword"));
		element("btn_submit").click();
		String profilename=element("txt_profilename").getText();
